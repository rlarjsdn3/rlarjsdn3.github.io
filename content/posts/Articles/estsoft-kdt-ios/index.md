...
세 차례의 팀 프로젝트 모두에서 팀장을 맡았습니다. 일부는 자진해서 맡았지만, 계속 팀장을 하는 것이 과연 바람직한지에 대한 고민도 있었습니다.

첫째, 저는 이전 팀 프로젝트에서도 늘 팀장을 맡아왔습니다. 그렇다 보니 제 팀 운영 방식이 팀원들에게 긍정적으로 작용했는지, 혹시 불편을 주지는 않았는지 확신하기 어려웠습니다. 팀원 입장에서는 불만을 직접 표현하기가 쉽지 않기 때문에, 혹시 부정적인 부분이 있다면 알기 어렵다는 점이 고민이었습니다.

둘째, 다른 사람의 팀 운영 방식을 배우고 싶었습니다. 기획을 어떻게 주도하는지, 문제가 생겼을 때 어떤 방식으로 해결하는지 등 다양한 케이스를 경험해 보는 것도 중요한 배움의 과정이라고 생각했기 때문입니다.
